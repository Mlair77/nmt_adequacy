...
from onmt.utils.parse import ArgumentParser   # ArgumentParser是自定义的
...
def train(opt):
    ...
    nb_gpu = len(opt.gpu_ranks)  # for example : gpu_rankes = 0 1 2 3
    ...
    if opt.world_size > 1:
        ...
        # queue_size: Size of queue for each process in producer/consumer,default=400
