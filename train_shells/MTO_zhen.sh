data_dir=../data/zhen_data/onmt_data
signature=zhen_mto_"$1"_"$2"
work_dir=$your_code_dir
output_dir=$your_output_dir/zhen/$signature/
...
python  $code_dir/train.py -data $data_dir/wmt19_zhen -save_model $output_dir/$signature \
        ...
        -report_lm -fixed_lm -add_nmt_lm_loss -lambda_add_loss $2 -add_nmt_lm_loss_fn $1 -seed 7766 \
